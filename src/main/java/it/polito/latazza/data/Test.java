...
class Mytests{
    ...
    void Alltest(){
        ...
        assertEquals(1,DataTest.createBeverage("Caff̬",5,500));
        Id=DataTest.getBeveragesId();
        Emp=DataTest.getBeverages();
        assertEquals(1,Id.size());
        assertEquals(1,Emp.size());
        Name=Collections.singletonList("Caff̬");
        Id.forEach(elem->{
            assertEquals(i,elem);
            assertEquals(Emp.get(i),Name.get(i));
            i++;
        ...
        assertEquals("Caff̬",DataTest.getBeverageName(1));
        ...
        assertEquals(2,Id.size());
        assertEquals(2,Emp.size());
        Name=Arrays.asList("Caff̬", "Cioccolata");
        Id.forEach(elem->{
            assertEquals(i,elem);
            assertEquals(Emp.get(i),Name.get(i));
            i++;
